    ...
    return (
        <div className="container mx-auto py-4 w-full bg-white border-b border-slate-100 mb-4">
            <div className="w-full flex gap-4 items-center">
                ...
                <button type="button" className="text-white flex gap-1 bg-slate-700 hover:bg-slate-800 focus:ring-4 focus:ring-slate-300 font-medium rounded-lg text-sm p-2.5 me-2 mb-2 dark:bg-slate-600 dark:hover:bg-slate-700 focus:outline-none dark:focus:ring-slate-800">
